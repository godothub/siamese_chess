...
# 通用准备工作，以及Linux版
RUN apk update \
 && apk add --no-cache curl wget zip git git-lfs scons pkgconf gcc g++ libatomic libx11-dev libxcursor-dev libxinerama-dev libxi-dev libxrandr-dev mesa-dev eudev-dev alsa-lib-dev pulseaudio-dev

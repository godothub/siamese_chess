...
OldPastorEngine::OldPastorEngine()
{
...
void OldPastorEngine::generate_good_capture_move(godot::PackedInt32Array &output, const godot::Ref<State> &_state, int _group)
{
...
int OldPastorEngine::get_piece_score(int _by, int _piece, int phase)
{
...
int OldPastorEngine::evaluate(const godot::Ref<State> &_state)
{
	int score = 0;
	int total_phase = 24;
...
int OldPastorEngine::compare_move(int a, int b, int best_move, int killer_1, int killer_2, const godot::Ref<State> &state)
{
	if (a == b)
		return false;
	if (best_move == a)
...
int OldPastorEngine::quies(const godot::Ref<State> &_state, int _alpha, int _beta, int _group, int _ply)
{
...
int OldPastorEngine::get_search_result()
{
	std::mt19937_64 rng(time(nullptr));
	return acceptable_move[rng() % acceptable_move.size()];
}

godot::PackedInt32Array OldPastorEngine::get_principal_variation()
{
	return principal_variation;
}

int OldPastorEngine::get_score()
{
	return searched_move[principal_move];
}

int OldPastorEngine::get_deepest_ply()
{
	return deepest_ply;
}

int OldPastorEngine::get_deepest_depth()
{
	return deepest_depth;
}

int OldPastorEngine::get_evaluated_position()
{
	return evaluated_position;
}

int OldPastorEngine::get_beta_cutoff()
{
	return beta_cutoff;
}

int OldPastorEngine::get_transposition_table_cutoff()
{
...
void OldPastorEngine::set_null_move_enabled(bool _can_null)
{
	can_null = _can_null;
}
...
void OldPastorEngine::set_transposition_table_enabled(bool _can_transposition_table)
{
	can_transposition_table = _can_transposition_table;
}

void OldPastorEngine::set_principle_variation_enabled(bool _can_principle_variation)
{
	can_principle_variation = _can_principle_variation;
}

void OldPastorEngine::set_despise_factor(int _despise_factor)
{
	despise_factor = _despise_factor;
}

void OldPastorEngine::set_transposition_table(const godot::Ref<TranspositionTable> &_transposition_table)
{
	transposition_table = _transposition_table;
}

void OldPastorEngine::set_think_time(double _think_time)
{
	think_time = _think_time;
}

godot::Ref<TranspositionTable> OldPastorEngine::get_transposition_table() const
{
	return this->transposition_table;
}

void OldPastorEngine::_bind_methods()
{
	godot::ClassDB::bind_method(godot::D_METHOD("search"), &OldPastorEngine::search);
	godot::ClassDB::bind_method(godot::D_METHOD("get_search_result"), &OldPastorEngine::get_search_result);
	godot::ClassDB::bind_method(godot::D_METHOD("get_score"), &OldPastorEngine::get_score);
	godot::ClassDB::bind_method(godot::D_METHOD("get_deepest_ply"), &OldPastorEngine::get_deepest_ply);
	godot::ClassDB::bind_method(godot::D_METHOD("get_deepest_depth"), &OldPastorEngine::get_deepest_depth);
	...
	godot::ClassDB::bind_method(godot::D_METHOD("set_null_move_enabled"), &OldPastorEngine::set_null_move_enabled);
	godot::ClassDB::bind_method(godot::D_METHOD("set_transposition_table_enabled"), &OldPastorEngine::set_transposition_table_enabled);
	godot::ClassDB::bind_method(godot::D_METHOD("set_principle_variation_enabled"), &OldPastorEngine::set_principle_variation_enabled);
	...
	godot::ClassDB::bind_method(godot::D_METHOD("get_transposition_table"), &OldPastorEngine::get_transposition_table);
